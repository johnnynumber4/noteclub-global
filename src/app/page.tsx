        ...
        <Container maxWidth="lg">
          <Card
            sx={{
              ...
              textAlign: "center",
              background:
                "linear-gradient(135deg, rgba(211, 47, 47, 0.1), rgba(33, 150, 243, 0.1), rgba(156, 39, 176, 0.1))",
              position: "relative",
              overflow: "hidden",
            }}
          >
            <Stack spacing={4}>
              ...
              <Typography
                ...
                mx="auto"
              >
                Dive into the decade that defined a generation. From grunge to
                hip-hop, alternative to electronic - share the albums that
                captured the spirit of the 90s.
              </Typography>
              ...
              <Stack
                ...
                justifyContent="center"
              >
                <Chip label="Next: Alex_M" color="primary" />
                <Chip label="7 days left" color="secondary" />
                <Chip
                  label="12 albums shared"
        ...
        <Container maxWidth="md">
          <Stack spacing={6} textAlign="center">
            ...
            <Typography variant="h5" color="text.secondary">
              Join thousands of music lovers sharing incredible albums and
              discovering their next favorite artist.
            </Typography>
            <Button
              component={Link}
              href="/auth/signup"
